        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcquiredCredits = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Programme = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    EducationLevel = table.Column<string>(type: "TEXT", maxLength: 25, nullable: true),
                    FirstTeacherId = table.Column<int>(type: "INTEGER", nullable: true),
                    SecondTeacherId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeminarUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ProjectUrl = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ExamPoints = table.Column<int>(type: "INTEGER", nullable: true),
                    SeminarPoints = table.Column<int>(type: "INTEGER", nullable: true),
                    ProjectPoints = table.Column<int>(type: "INTEGER", nullable: true),
                    AdditionalPoints = table.Column<int>(type: "INTEGER", nullable: true),
